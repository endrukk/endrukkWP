...
class SiteOrigin_Widget_SlickSlider_Widget extends SiteOrigin_Widget_Base_Slider {
	function __construct() {
		parent::__construct(
			'sow-slider',
			__('SiteOrigin Slick Slider', 'so-widgets-bundle'),
			array(
				'description' => __('A responsive slick slider widget that supports images and video.', 'so-widgets-bundle'),
...
siteorigin_widget_register('sow-slickslider', __FILE__, 'SiteOrigin_Widget_SlickSlider_Widget');
